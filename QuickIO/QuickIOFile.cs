...
namespace SchwabenCode.QuickIO
{
    ...
    public static partial class QuickIOFile
    {
        ...
        /// <remarks>http://msdn.microsoft.com/en-us/library/c6cfw35a(v=vs.110).aspx</remarks>
        /// <exception cref="FileSystemIsBusyException">Filesystem is busy</exception>
        public static void Copy( string uncSourceFullName, string uncTargetFullName, Boolean overwrite = false, Boolean createRecursive = true )
        {
            ...
            if ( createRecursive )
            {
                var targetDirectoryPath = QuickIOPath.GetParentPath( uncTargetFullName );
                try
                {
