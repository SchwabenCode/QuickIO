...
namespace SchwabenCode.QuickIO
{
    public static partial class QuickIO
    {
        ...
        {
            Contract.Requires( !String.IsNullOrWhiteSpace( path ) );
            Contract.Ensures( Contract.Result<Task<IEnumerable<QuickIOFileInfo>>>( ) != null );
        ...
        {
            Contract.Requires( !String.IsNullOrWhiteSpace( path ) );
            Contract.Ensures( Contract.Result<Task<IEnumerable<QuickIODirectoryInfo>>>( ) != null );
        ...
        {
            Contract.Requires( !String.IsNullOrWhiteSpace( path ) );
            Contract.Ensures( Contract.Result<Task<QuickIODiskInformation>>( ) != null );
