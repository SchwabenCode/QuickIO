...
namespace SchwabenCode.QuickIO
{
    ...
    public static partial class QuickIOFile
    {
        ...
        {
            Create( pathInfo.FullNameUnc, fileAccess, fileShare, fileMode, fileAttributes );
        }
        ...
        {
            return OpenFileStream( path, FileAccess.ReadWrite, FileMode.Create, FileShare.None, bufferSize );
        ...
        {
            return Create( pathInfo.FullNameUnc, bufferSize );
        }
        ...
        {
            return new StreamWriter( OpenFileStream( path, FileAccess.ReadWrite, FileMode.Create, FileShare.None ) );
        }
        ...
        {
            return CreateText( pathInfo.FullNameUnc );
        }
    }
}
