...
namespace SchwabenCode.QuickIO.Transfer
{
    ...
    public class QuickIOTransferBackgroundService : QuickIOTransferServiceBase
    {
        ...
        public QuickIOTransferBackgroundService( int workerCount, int maxFileRetry = 3, bool autostart = true )
            : this( null, Math.Max( workerCount, 1 ), Math.Max( maxFileRetry, 0 ) )
        {
            Contract.Requires( workerCount >= 1 );
            Contract.Requires( maxFileRetry >= 0 );
        ...
        public QuickIOTransferBackgroundService( IQuickIOTransferObserver observer, int workerCount, int maxFileRetry = 3, bool autostart = true )
            : base( observer, Math.Max( workerCount, 1 ), Math.Max( maxFileRetry, 0 ) )
        {
            Contract.Requires( workerCount >= 1 );
            Contract.Requires( maxFileRetry >= 0 );
        ...
        /// <exception cref="OperationCanceledException">Queue is already cancelled.</exception>
        /// <exception cref="OperationCanceledException">Adding is completed.</exception>
        public void Add( QuickIOTransferFileCopyJob queueItem )
        {
            Contract.Requires( queueItem != null );
            ...
            if( AddingCompleted )
            {
                throw new OperationCanceledException( "Adding is completed." );
            }
        ...
        public new void AddWorker( Int32 count = 1 )
        {
            ...
            base.AddWorker( Math.Max( 1, count ) );
        }
        ...
        public new void RemoveWorker( Int32 count = 1 )
        {
            ...
            base.RemoveWorker( Math.Max( 1, count ) );
        }
