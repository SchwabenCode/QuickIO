...
public partial class QuickIOTransferFileCopyService : QuickIOTransferServiceBase
{
    ...
    /// </code>
    /// </example>
    public QuickIOTransferFileCopyService(IQuickIOTransferObserver observer, QuickIOFileInfo sourceFileInfo, string targetFullName, int threadCount = 1, int retryCount = 3, bool overwrite = false)
    ...
    /// </code>
    /// </example>
    public QuickIOTransferFileCopyService(QuickIOFileInfo sourceFileInfo, string targetFullName, int threadCount = 1, int retryCount = 3, bool overwrite = false)
    ...
    ///  ]]></code>
    ///  </example>
    public QuickIOTransferFileCopyService(IEnumerable<QuickIOFileInfo> sourceFileInfos, string targetFullName, int threadCount = 1, int retryCount = 3, bool overwrite = false)
    ...
    ///  ]]></code>
    ///  </example>
    public QuickIOTransferFileCopyService(IQuickIOTransferObserver? observer, IEnumerable<QuickIOFileInfo> sourceFileInfos, string targetFullName, int threadCount = 1, int retryCount = 3, bool overwrite = false)
    ...
    private readonly object _totalBytesTransferedLock = new( );
    ...
    /// </summary>
    public ulong TotalBytesTransfered
    {
        get
        {
    ...
    public double BytesPerSecond
    {
        get
        {
            ulong transfered = TotalBytesTransfered;
    ...
    public void Start()
    {
        try
        {
            ...
            string targetUnc = QuickIOPath.ToUncPath( TargetFullName );

            List<QuickIOTransferJob> fileTransferQueueItems = [];

            foreach (QuickIOFileInfo file in SourceFileInfos)
            {

                string target = targetUnc + QuickIOPath.DirectorySeparatorChar + file.Name;
