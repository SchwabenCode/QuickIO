...
namespace SchwabenCode.QuickIO.Transfer
{
    ...
    public abstract class QuickIOTransferJob : IQuickIOTransferJob
    {
        ...
        protected QuickIOTransferJob( IQuickIOTransferObserver observer, Int32 priorityLevel = 0, CancellationToken cancellationToken = default( CancellationToken )
 )
        {
            Observer = observer;
        ...
        /// <param name="cancellationToken">Cancellation Token</param>
        /// <remarks>Thread-safe</remarks>
        protected QuickIOTransferJob( Int32 priorityLevel = 0, CancellationToken cancellationToken = default( CancellationToken ) )
