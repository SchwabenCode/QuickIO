...
public class QuickIOTransferObserver : IQuickIOTransferObserver
{
    ...
    {
        FileCreationError?.Invoke(this, args);
    }
    /// <summary>
    ...
    {
        FileCreationProgress?.Invoke(this, args);
    }
    /// <summary>
    ...
    {
        FileCreationStarted?.Invoke(this, args);
    }
    /// <summary>
    ...
    {
        FileCreationFinished?.Invoke(this, args);
    }
    #endregion
    ...
    {
        CompletedAddingRequested?.Invoke(this, args);
    }
    /// <summary>
    ...
    {
        WorkerIsWaiting?.Invoke(this, args);
    }
    ...
    {
        WorkerPickedJob?.Invoke(this, args);
    }
    /// <summary>
    ...
    {
        WorkerCreated?.Invoke(this, args);
    }
    /// <summary>
    ...
    {
        WorkerStarted?.Invoke(this, args);
    }
    /// <summary>
    ...
    {
        WorkerShutdown?.Invoke(this, args);
    }
    ...
    {
        JobRetryMaxReached?.Invoke(this, args);
    }
    #endregion
}
