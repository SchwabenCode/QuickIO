...
public class QuickIOTransferDirectoryCreationJob : QuickIOTransferJob
{
    ...
    public QuickIOTransferDirectoryCreationJob(string directoryToCreatePath, bool overwrite = true, int prorityLevel = 1)
    ...
    /// <param name="overwrite">true to overwrite</param>
    /// <param name="prorityLevel">Priority level of directory creation should be higher than file creation without parent check</param>
    public QuickIOTransferDirectoryCreationJob(IQuickIOTransferObserver? observer, string directoryToCreatePath, bool overwrite = true, int prorityLevel = 1)
