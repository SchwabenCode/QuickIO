...
public class QuickIOTransferFileCopyProgressEventArgs : QuickIOTransferJobWriteWithSourceEventArgs
{
    ...
    public QuickIOTransferFileCopyProgressEventArgs(IQuickIOTransferJob job, string sourcePath, string targetPath, long totalBytes, ulong bytesTransfered, DateTime transferStarted)
