...
namespace SchwabenCode.QuickIO.Win32
{
    ...
    internal static class Win32SafeNativeMethods
    {
        ...
        public static extern uint GetSecurityDescriptorLength( IntPtr byteArray );
        ...
        [DllImport( "advapi32.dll", SetLastError = true, CharSet = CharSet.Unicode )]
        public static extern bool ConvertStringSidToSid( String sidString, ref IntPtr sidHandle );

        [DllImport( "advapi32.dll", SetLastError = true, CharSet = CharSet.Unicode )]
        public static extern uint LookupAccountSid( String systemName, IntPtr sidHandle, StringBuilder name, ref int cchName, StringBuilder domainName, ref int cchDomainName, out int peUse );
        ...
        public static extern Int32 SetAllFileTimes( SafeFileHandle fileHandle, ref long lpCreationTime, ref long lpLastAccessTime, ref long lpLastWriteTime );
        ...
        public static extern bool SetCreationFileTime( SafeFileHandle hFile, ref long lpCreationTime, IntPtr lpLastAccessTime, IntPtr lpLastWriteTime );
        ...
        [DllImport( "kernel32.dll", SetLastError = true, EntryPoint = "SetFileTime", ExactSpelling = true )]
        [return: MarshalAs( UnmanagedType.Bool )]
        public static extern bool SetLastAccessFileTime( SafeFileHandle hFile, IntPtr lpCreationTime, ref long lpLastAccessTime, IntPtr lpLastWriteTime );
        ...
        [DllImport( "kernel32.dll", SetLastError = true, EntryPoint = "SetFileTime", ExactSpelling = true )]
        [return: MarshalAs( UnmanagedType.Bool )]
        public static extern bool SetLastWriteFileTime( SafeFileHandle hFile, IntPtr lpCreationTime, IntPtr lpLastAccessTime, ref long lpLastWriteTime );
        ...
        [return: MarshalAs( UnmanagedType.Bool )]
        public static extern bool CreateDirectory( string fullName, IntPtr securityAttributes );
        ...
        public static extern SafeFileHandle OpenReadWriteFileSystemEntryHandle(
             string fullName,
             uint dwAccess,
             [MarshalAs( UnmanagedType.U4 )] FileShare dwShareMode,
             IntPtr lpSecurityAttributes,
        ...
        /// </summary>
        [DllImport( "kernel32.dll", SetLastError = true, CharSet = CharSet.Unicode, EntryPoint = "CreateFile" )]
        public static extern SafeFileHandle CreateFileForAppend(
             string fullName,
        ...
        public static extern Win32FileHandle FindFirstFile( string fullName, [In, Out] Win32FindData win32FindData );
        ...
        [DllImport( "kernel32.dll", CharSet = CharSet.Unicode, SetLastError = true )]
        [return: MarshalAs( UnmanagedType.Bool )]
        public static extern bool MoveFile( string fullNameSource, string fullNameTarget );
        ...
        [DllImport( "kernel32.dll", CharSet = CharSet.Unicode, SetLastError = true )]
        [return: MarshalAs( UnmanagedType.Bool )]
        public static extern bool CopyFile( string fullNameSource, string fullNameTarget, bool failOnExists );
        ...
        [DllImport( "kernel32.dll", CharSet = CharSet.Unicode, SetLastError = true )]
        [return: MarshalAs( UnmanagedType.Bool )]
        public static extern bool DeleteFile( string fullName );
        ...
        [DllImport( "kernel32.dll", CharSet = CharSet.Unicode, SetLastError = true )]
        [return: MarshalAs( UnmanagedType.Bool )]
        public static extern bool RemoveDirectory( string fullName );

        /// <summary>
        /// Set File Attributes
        /// </summary>
        [DllImport( "kernel32.dll", CharSet = CharSet.Unicode, SetLastError = true )]
        public static extern bool SetFileAttributes( string fullName, uint fileAttributes );

        /// <summary>
        /// Gets Attributes of given path
        /// </summary>
        [DllImport( "kernel32.dll", CharSet = CharSet.Unicode, SetLastError = true )]
        public static extern uint GetFileAttributes( string fullName );

        /// <summary>
        /// Close Hnalde
        /// </summary>
        [DllImport( "kernel32.dll", SetLastError = false, CharSet = CharSet.Unicode )]
        public static extern bool FindClose( SafeHandle fileHandle );
        ...
        [DllImport( "kernel32.dll", SetLastError = true, CharSet = CharSet.Unicode )]
        [return: MarshalAs( UnmanagedType.Bool )]
        public static extern bool GetDiskFreeSpaceEx( string uncPath,
