...
namespace SchwabenCode.QuickIO
{
    ...
    public static partial class QuickIOPath
    {
        ...
        public static String GetDirectoryName(string path)
        {
            ...
            string pathWithoutFolderName = cleanPath.Substring(0, lastDirectorySeparatorChar + 1);

            // dont trim if path is now root!
            if(IsRoot(pathWithoutFolderName))
            {
                return pathWithoutFolderName;
            }
